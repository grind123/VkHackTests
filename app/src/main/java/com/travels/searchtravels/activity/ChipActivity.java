        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                     ...
                     */
                    String mockJson = "[{\"type\": \"city\", \"country_name\": \"Russia\", \"state_code\": null, \"code\": \"MOW\", \"country_code\": \"RU\", \"weight\": 1006321, \"country_cases\": null, \"cases\": null, \"main_airport_name\": null}]";
                    BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(mockJson.getBytes())));
